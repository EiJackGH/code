...
## 2025-07-28 - Explicit Game Controls
**Learning:** When building interactive HTML5 widgets or games with custom keyboard event bindings, users often struggle to discover the required inputs without visual cues.
**Action:** Always provide explicit, visible instructional text for custom keyboard interactions, ensuring they do not block pointer events.
