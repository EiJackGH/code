...
## 2024-07-23 - Keyboard Accessibility Hint
**Learning:** When building interactive HTML5 widgets or games with custom keyboard event bindings, users lack visual cues about required inputs.
**Action:** Always provide explicit, visible instructional text for custom keyboard interactions.
