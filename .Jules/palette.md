...
## 2024-08-27 - Highlighting Keyboard Shortcuts
...
**Action:** When instructional text refers to keyboard interactions, use `<kbd>` tags and style them to resemble physical keys.
