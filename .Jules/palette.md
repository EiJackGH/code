...
## 2024-07-16 - Game Keyboard Instructions
...
**Action:** Add instructional text explicitly beneath score elements or similar static headers instead of burying them in off-screen areas.

## 2024-07-16 - Accessible Dynamic Scores
**Learning:** Dynamic text changes, such as scores updating in a game, are invisible to screen readers without specific ARIA tags.
**Action:** Add `aria-live="polite"` and `aria-atomic="true"` to score elements to maintain screen reader accessibility during dynamic updates.
