...
## 2025-05-19 - Explicit Input Instructions for Web Games
**Learning:** When building interactive HTML5 widgets or games with custom keyboard event bindings, users may not know the required inputs naturally. Relying on trial and error can be frustrating.
**Action:** Always provide explicit, visible instructional text so users know the required inputs.
