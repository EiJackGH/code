...
## 2024-03-10 - Keyboard Shortcut Visibility
**Learning:** Explicitly highlighting keyboard shortcuts using semantic <kbd> tags with physical key styling improves intuitiveness and discoverability. Text-shadows on containers improve contrast but must be negated on styled child elements to avoid unwanted visual inheritance.
**Action:** Always wrap key shortcuts in <kbd> and manage inherited text-shadow carefully.
