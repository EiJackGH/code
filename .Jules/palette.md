...
## 2025-10-10 - Keyboard Shortcut Semantics
**Learning:** Explicitly highlighting keyboard shortcuts using semantic <kbd> tags with physical key styling improves intuitiveness and discoverability against dynamic backgrounds.
**Action:** Always wrap key shortcuts in <kbd> and apply text-shadows to ensure high contrast and visual distinction for keyboard instructions.
