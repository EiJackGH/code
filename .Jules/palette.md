...
## 2025-01-20 - Explicit Keyboard Instructions for Web Games
...
**Action:** Add a visible hint to web-based game canvases to display required keyboard bindings visually without blocking user interactions.
